...
export const ApplicationsSummary = ({stats}: {stats: models.ApplicationListStats}) => {
    ...
    const charts = [
        ...
        {
            title: 'Health',
            data: Object.keys(stats.totalByHealthStatus).map(key => ({title: key, value: stats.totalByHealthStatus[key], color: healthColors.get(key as models.HealthStatusCode)})),
